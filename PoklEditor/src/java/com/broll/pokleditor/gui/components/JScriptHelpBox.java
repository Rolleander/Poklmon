...
public class JScriptHelpBox extends JPanel {
    ...
    public void addObject(String className, String name) {
        Class clazz = DebuggerClasses.getClass(className);
        if(clazz==null){
            System.err.println("Couldnt find debugger class: "+className);
            return;
        }
