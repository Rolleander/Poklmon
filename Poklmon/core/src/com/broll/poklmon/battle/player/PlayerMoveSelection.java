...
public class PlayerMoveSelection {
    ...
    private FightAttack overwriteAttack;
    ...
    public void processInput(ProcessThreadHandler listener, FightAttack overwriteAttack) {
        ...
        this.overwriteAttack = overwriteAttack;
        if (overwriteAttack == null) {
            //verzweifeler (in case of no AP its used automatically)
            this.overwriteAttack = StateEffectCalc.getDesperationAttack();
        } else {
                    ...
                    switch (actionsBox.getSelectedIndex()) {
                        case 0:
                            ...
                            if (canChooseAttack) {
                                ...
                                nextMove = new BattleMove(this.overwriteAttack);
                                stop();
                            }
                            break;
                        case 1:
