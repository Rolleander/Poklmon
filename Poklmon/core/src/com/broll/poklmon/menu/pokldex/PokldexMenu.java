...
public class PokldexMenu extends MenuPage {
    ...
    public void onEnter() {
        ...
        Collections.sort(poklmons, new Comparator<Poklmon>() {
            ...
            public int compare(Poklmon o1, Poklmon o2) {
                int nr1 = getPoklDexNumber(o1);
                int nr2 = getPoklDexNumber(o2);
                return nr1 < nr2 ? -1 : nr1 == nr2 ? 0 : 1;
            }
        });
        maxNr = poklmons.size() - 1;
        selection = new ScrollableSelectionContext(data, poklmons.size(), ENTRIES);
        selection.setAllowJumping(true);
    }

    private int getPoklDexNumber(Poklmon poklmon) {
        return poklmon.getPokldexNumber() > 0 ? poklmon.getPokldexNumber() : poklmons.indexOf(poklmon);
    }
    ...
    public void render(Graphics g) {
        ...
        for (int i = 0; i < ENTRIES; i++) {
            ...
            int nr = getPoklDexNumber(poklmons.get(id));
