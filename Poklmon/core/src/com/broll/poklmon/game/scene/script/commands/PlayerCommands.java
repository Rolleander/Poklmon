...
import com.broll.poklmon.game.scene.script.commands.subtasks.LevelUpHandler;
...
public class PlayerCommands extends CommandControl {
	...
	public void movePlayer(final ObjectDirection direction) {
		...
		invoke(new Invoke(){ public void invoke() throws VariableException {op.move(direction, new MoveCommandListener() {
