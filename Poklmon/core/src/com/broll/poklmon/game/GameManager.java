...
public class GameManager {
    ...
    private void prepareBattle(BattleParticipants participants, boolean introSound) {
        data.getMusics().stop();
        if (introSound) {
    ...
    public void startBattle(BattleParticipants participants, ScreenTransition transition, BattleEndListener endListener) {
        prepareBattle(participants, true);
    ...
    public void customBattle(BattleParticipants participants, ScreenTransition transition, BattleProcessCore core, BattleEndListener endListener) {
        prepareBattle(participants, false);
        mapState.startCustomBattle(participants, core, transition, endListener);
    }
